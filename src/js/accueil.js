...
export default class accueil extends Phaser.Scene {
    ...
    var arrayButtons =[];
    const bouton_credits = this.add.image(this.game.config.width/2, 550, "button_credits"); // Réglez la valeur selon vos besoins
    const bouton_controls = this.add.image(this.game.config.width/2, 550, "button_controls"); // Réglez la valeur selon vos besoins
