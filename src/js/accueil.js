...
export default class accueil extends Phaser.Scene {
    ...
    var arrayButtons =[];
    const bouton_credits = this.add.image(this.game.config.width/3.4, 600, "button_credits"); // Réglez la valeur selon vos besoins
    const bouton_controls = this.add.image(this.game.config.width/1.4, 600, "button_controls"); // Réglez la valeur selon vos besoins
    const bouton_play = this.add.image(this.game.config.width/2, 600, "button_play"); // Réglez la valeur selon vos besoins
