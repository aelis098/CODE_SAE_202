...
export default class accueil extends Phaser.Scene {
    ...
    var arrayButtons =[];
    const bouton_credits = this.add.image(this.game.config.width/550, 600, "button_credits"); // Réglez la valeur selon vos besoins
    const bouton_controls = this.add.image(this.game.config.width/390, 550, "button_controls"); // Réglez la valeur selon vos besoins
    const bouton_play = this.add.image(this.game.config.width/250, 550, "button_play"); // Réglez la valeur selon vos besoins
